...
class SpeechAndPersonRecognition:
    def __init__(self):
        ...
        self.riddle_req_pub = rospy.Publisher('/riddle_req',String,queue_size=1)
        self.speech_localizatioin_req_pub = rospy.Publisher('/speech/localization_req',Bool,queue_size=1)
    ...
    def stateSizeOfTheCrowd(self):#------state 1
        ...
        rospy.sleep(3.0)
        self.speech_req_pub.publish(True)
        self.speech_localizatioin_req_pub.publish(True)
        return 2 #next state
